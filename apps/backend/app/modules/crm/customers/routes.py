...
from app.modules.crm.customers.models import CustomerStatus
from app.modules.crm.customers.schemas import CustomerCreate, CustomerResponse, CustomerUpdate
from app.modules.crm.customers import service
