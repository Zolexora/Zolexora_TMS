...
from app.modules.fleet.vehicles.schemas import VehicleCreate, VehicleResponse, VehicleUpdate, VehicleBodyType, VehicleOperationalStatus, VehicleOwnershipType
from app.modules.fleet.vehicles import service
