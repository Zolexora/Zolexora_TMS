...
from app.modules.operations.bookings.enums import BookingRequestStatus, BookingStatus
...
async def confirm_booking_request(ctx: TenantContext, request_id: uuid.UUID) -> BookingResponse:
    ...
    # Create the Booking!
    from app.modules.operations.bookings.service import _row_to_response
