...
from app.modules.operations.duties.models import Duty, DutyStatus
from app.modules.operations.trips.models import Trip, TripEvent, TripStatus
from app.modules.operations.trips.schemas import (
    TripCompleteRequest,
    TripEventResponse,
